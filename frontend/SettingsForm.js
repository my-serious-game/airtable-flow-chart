      ...
      >
        ...
        {settings.table && (
          <Fragment>
            ...
            <FormField label="Linked record table 1">
              <TablePickerSynced globalConfigKey={ConfigKeys.LINKED_FIELD1} />
              <FieldPickerSynced
                table={settings.table1}
                globalConfigKey={ConfigKeys.FIELD1_ID}
                allowedTypes={allowedFieldTypes}
              />
              <FieldPickerSynced
                table={settings.table1}
                globalConfigKey={ConfigKeys.FIELD1_1_ID}
                allowedTypes={allowedFieldTypes}
              />
            </FormField>
            <FormField label="Linked record table 2">
              <TablePickerSynced globalConfigKey={ConfigKeys.LINKED_FIELD2} />
              <FieldPickerSynced
                table={settings.table2}
                globalConfigKey={ConfigKeys.FIELD2_ID}
                allowedTypes={allowedFieldTypes}
              />
              <FieldPickerSynced
                table={settings.table2}
                globalConfigKey={ConfigKeys.FIELD2_2_ID}
                allowedTypes={allowedFieldTypes}
              />
            </FormField>
            <FormField
...
SettingsForm.propTypes = {
  ...
  settingsValidationResult: PropTypes.shape({
    settings: PropTypes.shape({
      ...
      chartOrientation: PropTypes.oneOf(Object.values(ChartOrientation))
        .isRequired,
